$( "#form" ).submit(function( event ) {
        ...
        error: function (jqXHR, status) {
			...
			if (codigo == 409) {
				const div = document.getElementById('modalText');
				const header = document.getElementById('modalHeader');
				div.textContent = 'The registration cannot be done more than 3 times';
				header.textContent = 'ERROR';
				event.preventDefault();
				$('#myModal').modal('show');
				...
				const div = document.getElementById('modalText');
				const header = document.getElementById('modalHeader');
				div.textContent = 'There has been an error in the registration';
				header.textContent = 'ERROR';
				event.preventDefault();
				$('#myModal').modal('show');
				...
				const div = document.getElementById('modalText');
				const header = document.getElementById('modalHeader');
				div.textContent = 'The registration has been sent successfully';
